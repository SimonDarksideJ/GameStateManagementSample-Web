# Game State Management (Mango, C#/VB) - Using the KNI Engine for the Web
...
The version in this repository includes an additional "Web" platform utilizing the Web template from the [KNI Engine project](https://github.com/kniEngine/kni).
This is to support the [starter article]() which describes its use.

> **Note* Gamepad and Touchscreen support have been excluded from the GameState Management library as they are not supported, updated code left in for reference.
